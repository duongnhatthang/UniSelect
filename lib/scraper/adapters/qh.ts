/**
 * QH Adapter — ĐẠI HỌC QUỐC GIA HÀ NỘI
 *
 * TODO: Before setting static_verified: true in scrapers.json:
 * 1. Visit https://www.vnu.edu.vn/home/ and find the cutoff scores page (Tuyển sinh -> Điểm chuẩn)
 ...
 * Ministry code: QH
 * Homepage: https://www.vnu.edu.vn/home/
 */
...
export const qhAdapter: ScraperAdapter = {
  id: 'QH',
  async scrape(url: string): Promise<RawRow[]> {
    ...
    if (rows.length === 0) {
      throw new Error(
        `QH adapter returned 0 rows — possible JS rendering or layout change at ${url}`
      );
    }
