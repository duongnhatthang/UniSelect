/**
 * TLA Adapter — Trường Đại học Thủy lợi
 *
 * TODO: Before setting static_verified: true in scrapers.json:
 * 1. Visit https://www.tlu.edu.vn/ and find the cutoff scores page (Tuyển sinh -> Điểm chuẩn)
 ...
 *
 * University: Trường Đại học Thủy lợi
 * Ministry code: TLA
